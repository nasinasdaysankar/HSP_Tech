    ...
    <section id="books" style={sectionStyle}>
      <div style={containerStyle}>
          ...
          {(loading ? sampleBooks : filtered).map((book, index) => (
            <div key={book.id || index} style={bookCardStyle}>
              ...
              <div style={bookContentStyle}>
                ...
                {book.price && <div style={{ fontWeight: 'bold', color: '#333', marginBottom: '1rem' }}>{book.price}</div>}
                <button
        ...
        <div style={{
          ...
          <h3 style={{ color: '#333', marginBottom: '0.5rem' }}>Bulk Orders Available</h3>
          <p style={{ color: '#555' }}>
            Email: <a href="mailto:hspbookspublishinghouse@gmail.com" style={{ color: '#333', fontWeight: 'bold' }}>hspbookspublishinghouse@gmail.com</a>
          </p>
        </div>
      </div>
    </section>
